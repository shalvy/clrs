...
showNotification(from, align) {
    ...
    html: '<div class="modal-content">' +
        ...
        '<span ng-hide="currentSection">Create new Section</span>' +
        '<form onsubmit="addSection(newSection)" class="ng-pristine ng-valid">' +
        '<input type="text" class="form-control col-md-4 ng-pristine ng-untouched ng-valid ng-empty"</h4> ' +
        'placeholder="Add sub-section to " ng-model="newSection.name"></form>' +
        '< /div>< div class= "modal-body"><div class="row">' +
        '<div class="col-md-5 col-md-offset-1">< div class= "form-group" ><label class="control-label">Section Name</ label >' +
        ' <input type="text" class="form-control ng-pristine ng-untouched ng-valid ng-empty" ng-model="newSection.name">' +
        '</div></div></div></div><div class= "modal-footer" >' +
        '<button type="button" class="btn btn-default" data-dismiss="modal" ng-click="addSection(newSection)">' +
        'Save Section</button>< /div></div>' +
        '<input class="form-control" placeholder="Event Title" id="input-field">' +
        '</div>',
    message: 'Welcome to <b>Colours</b> - Time sheet update.'
    }, {
        type: type[color],
        timer: 4000,
        placement: {
    ...
    if (type === 'input-field') {
      swal({
        ...
        html:
          ...
          '<span class="input-group-addon"><i style="height:26px" class="fa fa-search"></i></span>' +
          '</div>' +
      ...
      swal({
        ...
        html:
          ...
          '<div class="row">' +
          '<div class="col-md-12 pull-left" style="margin-left:1em">' +
          '<label class="modal-title">Create new Section</label>' +
          '<div class="spaser" style="height:1em"></div>' +
          '<div class="" style="margin-left:2em">' +
          '<input type="text" class="form-control col-md-4"placeholder="Add sub-section to ">' +
          // '<span class="input-group-addon"><i style="height:26px" class="fa fa-search"></i></span>' +
          '</div>' +
          '</div>' +
          '<div class="spaser" style="height:3em"></div>' +
