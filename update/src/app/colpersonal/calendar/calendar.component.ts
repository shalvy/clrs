    ...
    $calendar.fullCalendar({
      ...
      select: function (start, end) {
        ...
        <div class="modal-header">
          ...
          <h4 class="modal-title">
			 ...
			 <form onsubmit="addSection(newSection)" class="ng-pristine ng-valid">
			    <input type="text" class="form-control col-md-4 ng-pristine ng-untouched ng-valid ng-empty" placeholder="Add sub-section to " ng-model="newSection.name">
			 </form>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal" ng-click="addSection(newSection)">Save Section</button>
        </div>
      </div>
